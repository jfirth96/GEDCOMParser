...
CIS2750 Assignment 2 W18

This assignment was to extend our GEDCOM parsing library from A1 to be able to interact with our JavaScript front end that
will be developed for A3.
...
getDescendantListN:
	Create list of current generation "getChildrenOf"
	Get the children of each indiv in the current generation (generation n)
		* This is generation n+1
	Empty "getChildrenOf", refill with current generation
	Insert generation into descendants list
	Repeat for desired number of generations
	
getAncestorListN:
	Create list of current generation "getParentsOf"
	Get the parents of each indiv in the current generation (generation n)
		* This is generation n+1
	Empty "getParentsOf", refill with current generation
	Insert generation into ancestors list
	Repeat for desired number of generations
...
To compile this project in its entirety:
	make all
